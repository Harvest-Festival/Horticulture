...
public class HorticultureRecipes extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(HorticultureItems.GRAPE_JUICE.get(), 1).requires(HorticultureTags.GRAPE).requires(PenguinItems.GLASS.get()).unlockedBy("has_grape", has(HorticultureTags.GRAPE)).save(consumer, rl("grape_juice"));
