...
public class HorticultureRecipes extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(HorticultureItems.TOMATO_JUICE.get(), 1).requires(HorticultureTags.PINEAPPLE).requires(PenguinItems.GLASS.get()).unlockedBy("has_tomato", has(HorticultureTags.TOMATO)).save(consumer, rl("tomato_juice"));
        ShapelessRecipeBuilder.shapeless(HorticultureItems.STRAWBERRY_MILK.get(), 1).requires(HorticultureTags.PINEAPPLE).requires(PenguinItems.GLASS.get()).requires(Items.MILK_BUCKET).unlockedBy("has_strawberry", has(HorticultureTags.STRAWBERRY)).save(consumer, rl("strawberry_milk"));
        ShapelessRecipeBuilder.shapeless(HorticultureItems.GRAPE_JUICE.get(), 1).requires(HorticultureTags.PINEAPPLE).requires(PenguinItems.GLASS.get()).unlockedBy("has_grape", has(HorticultureTags.GRAPE)).save(consumer, rl("grape_juice"));
        ShapelessRecipeBuilder.shapeless(HorticultureItems.PEACH_JUICE.get(), 1).requires(HorticultureTags.PINEAPPLE).requires(PenguinItems.GLASS.get()).unlockedBy("has_peach", has(HorticultureTags.PEACH)).save(consumer, rl("peach_juice"));
        ShapelessRecipeBuilder.shapeless(HorticultureItems.BANANA_JUICE.get(), 1).requires(HorticultureTags.PINEAPPLE).requires(PenguinItems.GLASS.get()).unlockedBy("has_banana", has(HorticultureTags.BANANA)).save(consumer, rl("banana_juice"));
        ShapelessRecipeBuilder.shapeless(HorticultureItems.ORANGE_JUICE.get(), 1).requires(HorticultureTags.PINEAPPLE).requires(PenguinItems.GLASS.get()).unlockedBy("has_orange", has(HorticultureTags.ORANGE)).save(consumer, rl("orange_juice"));
        ShapelessRecipeBuilder.shapeless(HorticultureItems.APPLE_JUICE.get(), 1).requires(HorticultureTags.PINEAPPLE).requires(PenguinItems.GLASS.get()).unlockedBy("has_apple", has(PenguinTags.APPLE)).save(consumer, rl("apple_juice"));
        ...
        ShapelessRecipeBuilder.shapeless(HorticultureItems.STIR_FRY.get(), 1).requires(HorticultureTags.CABBAGE).requires(PenguinItems.DEEP_BOWL.get()).unlockedBy("has_cabbage", has(HorticultureTags.CABBAGE)).save(consumer, rl("stir_fry"));
